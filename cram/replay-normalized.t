frame text across the captured frames:
  $ env -u NO_COLOR -u CLICOLOR -u CLICOLOR_FORCE -u TERM -u PIPPA_REPLAY -u PIPPA_REPLAY_RAW -u PIPPA_REPLAY_SIZE COLORTERM=truecolor list-parity-app.exe --replay "/ f z enter"
  --- frame 0 ---
